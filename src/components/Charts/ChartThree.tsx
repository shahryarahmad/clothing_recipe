...
const ChartThree: React.FC = () => {
  ...
  return (
    <div className="sm:px-7.5 col-span-12 rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
      ...
      <div className="mb-2">
        <div id="chartThree" className="mt-32 mx-auto flex justify-center">
          <ReactApexChart
            options={options}
            series={state.series}
            type="donut"
      ...
      <div className="mt-20 -mx-8 flex flex-wrap items-center justify-center gap-y-3">
